...
function TextBoxForm(props) {
    return (
        <form className="noselect join-game-form" onSubmit={props.onSubmit}>
            ...
            <div className="join-game-response">{props.responseMessage}</div>
        </form>
    )
}
    ...
    render() {
        return (
            <div className="noselect main-menu">
                <img className="main-menu-logo noselect main-menu-logo-bounce" alt="Game Logo" src="client/assets/logo/logo.png"></img>
