export function generateClientConfig(config) {
    ...
    const BORDER_T = SPRITE_SIZE_MAP_PX
    const BORDER_B = SPRITE_SIZE_MAP_PX*2
    const BORDER_L = SPRITE_SIZE_MAP_PX
    const BORDER_R = SPRITE_SIZE_MAP_PX
    const APP_WIDTH = MAP_WIDTH + PLAYER_TOOLBAR_WIDTH + BORDER_L + BORDER_R
